...
export type { DepOptimizationMetadata, DepOptimizationOptions, DepOptimizationResult, DepOptimizationProcessing, OptimizedDepInfo, OptimizedDeps } from './optimizer';
...
export type { WebSocketServer, WebSocketClient, WebSocketCustomListener } from './server/ws';
...
export type { FSWatcher, WatchOptions, AwaitWriteFinishOptions } from 'types/chokidar';
